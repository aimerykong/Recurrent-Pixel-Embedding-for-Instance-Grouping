function generate_train_set_part2()
...
for i = 1:desiredNumber
    ...
    digitToken = randperm(10,1);
    idxlistTMP = find(trainLabels==digitToken);
    idxlistTMP = idxlistTMP(randperm(length(idxlistTMP)));
